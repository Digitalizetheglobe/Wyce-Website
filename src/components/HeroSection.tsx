...
export default function HeroSection() {
    return (
        <div className="relative bg-cover bg-center bg-no-repeat text-white  bg-black/100">
            ...
            {/* Banner Container */}
            <div className="relative w-full h-[750px] sm:h-[700px] md:h-screen flex items-center justify-center overflow-hidden"
                style={{
