...
export default function PhotoSection() {
  ...
  useEffect(() => {
    ...
    const autoScrollInterval = setInterval(() => {
      if (!isUserInteracting && scrollContainerRef.current) {
        ...
        const cardWidth = container.clientWidth * 0.3; // Each card takes 30% of viewport width
  ...
  return (
    <section
      className="relative bg-black/100 text-white py-20"
      style={{ backgroundImage: "url('/images/bg-image.png')" }} >
      {/* Dark overlay for better text readability */}
      <div className="absolute inset-0"></div>
      
      <div className="relative container ml-auto px-6 lg:px-40" style={{ paddingRight: '0px' }}>
        {/* SECTION HEADER */}
        <div className="mb-16 ">
        ...
        <div className="relative">
          {/* Full width container that touches right edge */}
          <div 
          ...
          >
            <div 
              className={`flex gap-6 pb-4 transition-all duration-500 ${
