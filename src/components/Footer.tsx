        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 text-sm mb-4 max-w-md">
              Your premier destination for exclusive real estate and luxury living experiences.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/nri-hub" className="text-gray-300 hover:text-white transition-colors">NRI Hub</Link></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-300 text-sm">
              © 2024 WYCE EXCLUSIVITY City. All rights reserved.
            </p>
