...
export default function BavdhanSection() {
  return (
    <section className="relative w-full overflow-hidden">
      ...
      {/* Mobile Background */}
      <div
        className="block md:hidden relative w-full min-h-[110vh] flex items-center justify-center px-4 sm:px-6 bg-cover bg-center bg-no-repeat overflow-hidden"
      ...
      {/* Tablet Background */}
      <div
        className="hidden md:block lg:hidden relative w-full min-h-[70vh] flex items-center justify-center px-4 sm:px-6 bg-cover bg-center bg-no-repeat overflow-hidden"
      ...
      >
        <motion.div
          ...
          transition={{ duration: 0.5, delay: 0.1 }}
          viewport={{ once: true }}
          className="w-full max-w-3xl text-center pt-20 px-2"
        >
      ...
      <div 
        className="hidden lg:block relative w-full h-screen bg-cover bg-center bg-no-repeat overflow-hidden"
      ...
      >
        <motion.div
          ...
          viewport={{ once: true }}
          className="absolute top-[15%] lg:top-[20%] left-[5%] lg:left-[10%] right-[5%] lg:right-auto z-10 w-auto lg:w-[500px] max-w-[90%] lg:max-w-none"
        >
