...
export default function PrivacyPolicyPage() {
  return (
    <>
      {/* Header Section */}
      <section className="w-full text-white py-10 md:py-6 bg-[#0a0a0a] border-b border-white/20" >
      ...
      <section className="w-full bg-black py-10 md:py-16">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="p-6 md:p-8 text-white">
            ...
            <div className="mb-8">
              <h2 className="text-xl md:text-2xl font-bold text-white mb-6">Interpretation and Definitions</h2>
              
              {/* Interpretation */}
              <div className="mb-6">
                <h3 className="text-lg md:text-xl font-semibold text-white mb-3">Interpretation</h3>
                <p className="text-gray-300 leading-relaxed">
              ...
              {/* Definitions */}
              <div className="mb-6">
                <h3 className="text-lg md:text-xl font-semibold text-white mb-3">Definitions</h3>
                <p className="text-gray-300 leading-relaxed mb-4">
                ...
                <ul className="space-y-3 text-gray-300">
                  ...
                  <li><strong className="text-white">Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to WYCE Exclucity CEC Office Siddharth Nagar Bavdhan 411021</li>
                  ...
                  <li><strong className="text-white">Website</strong> refers to basil group, accessible from https://www.wycecorp.com/</li>
            ...
            <div className="mb-8">
              <h2 className="text-xl md:text-2xl font-bold text-white mb-6">Collecting and Using Your Personal Data</h2>
              
              {/* Types of Data Collected */}
              <div className="mb-6">
                <h3 className="text-lg md:text-xl font-semibold text-white mb-4">Types of Data Collected</h3>
                
                {/* Personal Data */}
                <div className="mb-6">
                  <h4 className="text-base md:text-lg font-semibold text-white mb-3">Personal Data</h4>
                ...
                {/* Usage Data */}
                <div className="mb-6">
                  <h4 className="text-base md:text-lg font-semibold text-white mb-3">Usage Data</h4>
                  <p className="text-gray-300 leading-relaxed mb-3">
              ...
              <div className="mb-6">
                <h3 className="text-lg md:text-xl font-semibold text-white mb-4">Tracking Technologies and Cookies</h3>
                <p className="text-gray-300 leading-relaxed mb-4">
                ...
                <div className="space-y-4 mt-4">
                  <div className="bg-[#1a1a1a] rounded-lg p-4">
                    <h4 className="text-white font-semibold mb-2">Necessary / Essential Cookies</h4>
                    <p className="text-gray-300 mb-2"><strong>Type:</strong> Session Cookies</p>
                    <p className="text-gray-300 mb-2"><strong>Administered by:</strong> Us</p>
                  ...
                  <div className="bg-[#1a1a1a] rounded-lg p-4">
                    <h4 className="text-white font-semibold mb-2">Cookies Policy / Notice Acceptance Cookies</h4>
                    <p className="text-gray-300 mb-2"><strong>Type:</strong> Persistent Cookies</p>
                    <p className="text-gray-300 mb-2"><strong>Administered by:</strong> Us</p>
                    <p className="text-gray-300">
            ...
            <div className="mb-8">
              <h2 className="text-xl md:text-2xl font-bold text-white mb-4">Use of Your Personal Data</h2>
              <p className="text-gray-300 leading-relaxed mb-4">
            ...
            <div className="mb-8">
              <h2 className="text-xl md:text-2xl font-bold text-white mb-4">Retention of Your Personal Data</h2>
              <p className="text-gray-300 leading-relaxed mb-4">
            ...
            <div className="mb-8">
              <h2 className="text-xl md:text-2xl font-bold text-white mb-4">Transfer of Your Personal Data</h2>
              <p className="text-gray-300 leading-relaxed mb-4">
            ...
            <div className="mb-8">
              <h2 className="text-xl md:text-2xl font-bold text-white mb-4">Delete Your Personal Data</h2>
              <p className="text-gray-300 leading-relaxed mb-4">
            ...
            <div className="mb-8">
              <h2 className="text-xl md:text-2xl font-bold text-white mb-4">Disclosure of Your Personal Data</h2>
              
              {/* Business Transactions */}
              <div className="mb-6">
                <h3 className="text-lg md:text-xl font-semibold text-white mb-3">Business Transactions</h3>
                <p className="text-gray-300 leading-relaxed">
              ...
              {/* Law enforcement */}
              <div className="mb-6">
                <h3 className="text-lg md:text-xl font-semibold text-white mb-3">Law enforcement</h3>
                <p className="text-gray-300 leading-relaxed">
              ...
              <div className="mb-6">
                <h3 className="text-lg md:text-xl font-semibold text-white mb-3">Other legal requirements</h3>
                <p className="text-gray-300 leading-relaxed mb-3">
            ...
            <div className="mb-8">
              <h2 className="text-xl md:text-2xl font-bold text-white mb-4">Security of Your Personal Data</h2>
              <p className="text-gray-300 leading-relaxed">
            ...
            <div className="mb-8">
              <h2 className="text-xl md:text-2xl font-bold text-white mb-4">Links to Other Websites</h2>
              <p className="text-gray-300 leading-relaxed mb-4">
            ...
            <div className="mb-8">
              ...
              <div className="bg-[#1a1a1a] rounded-lg p-4">
                <p className="text-gray-300 font-medium ">WYCE Exclucity</p>
                <p className="text-gray-300">Email: sales@wycecorp.com</p>
                <p className="text-gray-300">Address: CEC Office, Siddharth Nagar, Bavdhan, Pune, Maharashtra 411021</p>
              </div>
            </div>
