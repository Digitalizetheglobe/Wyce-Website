  ...
  return (
    <html lang="en">
      ...
      >
        {/* Google Analytics */}
        <Script
          src={`https://www.googletagmanager.com/gtag/js?id=${process.env.NEXT_PUBLIC_GA_ID || 'G-K6VG584275'}`}
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: `
              ...
              gtag('js', new Date());
              gtag('config', '${process.env.NEXT_PUBLIC_GA_ID || 'G-K6VG584275'}');
            `,
          }}
        />
        {/* Google Ads Conversion Tracking */}
        <Script
          src={`https://www.googletagmanager.com/gtag/js?id=${process.env.NEXT_PUBLIC_GA_ADS_ID || 'AW-17718626787'}`}
          strategy="afterInteractive"
        />
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: `
              ...
              function gtag(){dataLayer.push(arguments);}
              gtag('js', new Date());
              gtag('config', '${process.env.NEXT_PUBLIC_GA_ADS_ID || 'AW-17718626787'}');
            `,
          }}
        />
        <link
